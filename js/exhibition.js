...
function initBanquet() {
  ...
  const FOOD_DATA = {
    ...
    chicken:    { zh: '鹽酥雞',   en: 'Taiwanese Fried Chicken', desc: '香酥雞塊與九層塔一同入鍋炸製，外皮香酥脆，是台灣宵夜文化的靈魂小吃。',                     wiki: 'Taiwanese_fried_chicken', fallback: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Yansuj%C3%AD.jpg/640px-Yansuj%C3%AD.jpg' },
    ...
    beefnoodle: { zh: '牛肉麵',   en: 'Beef Noodle Soup',        desc: '以紅燒湯底燉煮軟嫩牛腱，搭配彈牙麵條，是台灣最驕傲的國民美食，每年舉辦比賽選出最佳口味。', wiki: 'Beef_noodle_soup',        fallback: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Taiwan_beef_noodle_soup.jpg/640px-Taiwan_beef_noodle_soup.jpg', imgOverride: './8869cd181686929d.jpg' },
    bubbletea:  { zh: '珍珠奶茶', en: 'Bubble Tea',              desc: '1980年代發源於台灣台中，Q彈珍珠搭配奶茶，是台灣對世界飲料文化最大的貢獻。',               wiki: 'Bubble_tea',              fallback: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Bubble_tea_at_Fantaasia_2015.jpg/640px-Bubble_tea_at_Fantaasia_2015.jpg', imgOverride: './shutterstock_1271869054.jpg_1140x855.jpg' },
    ...
    coffin:     { zh: '棺材板',   en: 'Coffin Bread',            desc: '發源於台南，以厚片土司挖空後填入濃鬱奶油燉料，外酥內滑，名稱怪異卻深受喜愛。',             wiki: 'Coffin_bread',            fallback: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Coffin_bread.jpg/640px-Coffin_bread.jpg' },
